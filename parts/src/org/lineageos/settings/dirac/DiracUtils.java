...
public class DiracUtils {
    ...
    private void applySettings() {
        ...
        applyLevel(mPreferences.getString(PREF_PRESET, FLAT_PRESET), isEqualizerEnabled());
    ...
    public synchronized boolean isEnabledRequested() {
        return mPreferences.getBoolean(PREF_ENABLE, false);
    }

    public synchronized boolean isEqualizerEnabled() {
        return mPreferences.getBoolean(PREF_EQ, true);
    }

    public synchronized boolean isPauseDuringCallsEnabled() {
        return mPreferences.getBoolean(PREF_PAUSE, true);
    }
    ...
    public synchronized void setEqualizerEnabled(boolean enabled) {
        requireEffect();
        applyLevel(mPreferences.getString(PREF_PRESET, FLAT_PRESET), enabled);
